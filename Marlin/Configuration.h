...
#define STRING_CONFIG_H_AUTHOR "(GroM, Ender3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GroM E3Pro"
 ...
 */
//def: #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN

// Force the use of the probe for Z-axis homing
//def: //#define USE_PROBE_FOR_Z_HOMING
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -49, -13, 0 }
